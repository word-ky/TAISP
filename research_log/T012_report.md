...
Raw samples and all21predictionJSONs are already retained and checked on A6000 under `/home/liujianhua/wjq/TAISP/runs/20260912-212537-taisp-t012-coco1000-half-dose/artifacts/study/`; immutable archive `shared/t012_raw_receipts.tar.gz`. **Raw archival is complete:** the full archive SHA, all 21 prediction hashes and the 7,000-row samples SHA were verified locally. The original 60,392,049-byte samples.jsonl and all 21 prediction JSONs (314,186,349 bytes total; largest file 31,194,559 bytes) are included in the archival delivery. No inference was rerun. Recovery: [raw_archive_delivery.json](T012/raw_archive_delivery.json).
