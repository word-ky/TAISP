...
def run_smoke():
    ...
    repeated = adapt_clip_radius(x, isp, native, clip)
    repeat_phi_error = (repeated.phi-full.phi).abs().max().item()
    ...
    return {
        ...
        'repeat_full_phi_max_abs_error': repeat_phi_error, 'phi_max_abs_error': phi_error, 'image_max_abs_error': image_error,
