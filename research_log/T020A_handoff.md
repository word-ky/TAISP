...
Recovery: completed raw runs are retained in research_log/remote_runs and remote runs/. Renderer scripts/report_t020a.py is standard-library only; use PYTHONUTF8=1 on Windows. Do not rerun the completed experiment. Final report/raw receipt commit and A6000 mirror are recorded in .autodl/last-heartbeat.json.
