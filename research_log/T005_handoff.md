...
Full final report appended to CODEX_TO_CHATGPT.md; all raw predictions and receipts
retained. This final update supersedes historical active instructions below.
